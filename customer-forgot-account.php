        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4 class="messageText">Reset Account Successful</h4>
                    </div>
                    <div class="row">
                        <div class="center">
...
<div id="errorModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    ...
    <div class="content-wrapper">
        ...
        <h1>Get Help to <span>Hideout</span><span style="color: red;"> Garage</span></h1>
            <div class="img">
                <img src="img/forgotpage.svg">
            </div>
            <div class="loginForm">
                <form>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#submit').click(function (){
                ...
                if(valid && confirm("Are you sure to reset your account?")){
                    var form_data = {
                        uname : uname,
                        email : email
                    };
