                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover text-center" id="table11">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = mysqli_query($conn, "SELECT * FROM cars WHERE status='archived' or quantity < 1 ORDER BY car_id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo strlen($data['car_type']) > 5 ? substr($data['car_type'], 0, 7) . '...' : $data['car_type'];  ?></td>
