...
<div id="errorModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    ...
    <div class="content-wrapper">
        ...
        <h1 style="cursor: pointer;" onclick="goto('index.php')">Welcome to <span>Hideout</span><span style="color: red;"> Garage</span></h1>
            <div class="img">
                <img class="mainImageDisplay" src="img/Navigator.svg">
            </div>
            <div class="loginForm">
                <form>
