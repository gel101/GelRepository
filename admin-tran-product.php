                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item">Current Transaction</li>
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-warning" onclick="showOrder(
...
<div class="modal fade zoomIn" id="vanDetail">
	<div class="modal-dialog modal-lg modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h3 id="title">All Client Orders</h3>
                <button type="button" class="btn-close dismissBtn" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <div id="rightSideBtn">
                    ...
                    <button class="btn btn-success" onclick="completeBtn(document.getElementById('tranID').value, document.getElementById('clientID').value, document.getElementById('clientInfo').value)" id="completeBtn">ORDER COMPLETE <i class="fas fa-check-double"></i></button>
                    ...
                    <button type="button" class="btn btn-danger" onclick="declineBtn(document.getElementById('clientInfo').value, document.getElementById('clientID').value)" id="declineBtn">DECLINE <i class="fas fa-ban"></i></button>
                </div>
            </div>
		</div>
	</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="referenceNo">
                    <!-- <br>
                    <div class="row">
                        <img src="img/system/gcash.jpg" alt="Gcash QR Code">
                    </div> -->
                    <br>
                    <label for="" class="form-label">Reference Number</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="approveBtn(document.getElementById('clientID').value, document.getElementById('clientInfo').value, document.getElementById('paymentTerm').value, document.getElementById('paymentMode').value, document.getElementById('referenceInput').value)">CONFIRM</button>
...
<div class="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel3" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="approveBtnsparepart(document.getElementById('clientID').value, document.getElementById('clientInfo').value, document.getElementById('paymentTerm1').value, document.getElementById('paymentMode1').value, document.getElementById('referenceInput1').value)">CONFIRM</button>
                <button class="btn btn-danger" data-bs-target="#vanDetail" data-bs-toggle="modal" data-bs-dismiss="modal">BACK</button>
            </div>
        </div>
    </div>
...
<!-- END OF FOOTER -->
					...
					$.ajax({
                        ...
                        success: function(response){
                            ...
                            alert(response['msg']);
                                ...
                                // $('.messageText').text('Transaction Completed!'); // Change the text
                                $('#successModal').modal('show');
    ...
    function approveBtn(cust_id, tran_id, paymentTerm, paymentMode, referenceInput) {
        var valid = true;
        ...
        if (paymentMode == "Gcash") {
            ...
            if (typeof screenshot === "undefined" || screenshot === null) {
                valid = false;
                alert("E-wallet Payment Screenshot Empty!");
            }
        }
    ...
    function approveBtnsparepart(cust_id, tran_id, paymentTerm, paymentMode, referenceInput) {
        var valid = true;
    ...
    function completeBtn(order_id, cust_id, tran_id) {
        var valid = true;
    ...
    function declineBtn(tran_id, cust_id){
        var valid = true;
        var tran_id = tran_id;
