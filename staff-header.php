...
if (isset($_SESSION['staff_last_activity']) && (time() > ($_SESSION['staff_last_activity'] + 43200))) {
    echo "<script>
...
if ($_SESSION["staffLogin"] === false || !isset($_SESSION["staff_id"])) {
    echo "<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('hiddenButton').click();
    });
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" onclick="sawStatusBtn()" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        $sql123 = "SELECT * FROM notifications WHERE messageTo = 'staff' and saw_status= 0; ";
                        ...
                        ?>">
                            <?php 
                            $sql = "SELECT COUNT(notif_id) FROM notifications WHERE messageTo='staff' AND saw_status = 0;";
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <div class="dropdown-head bg-primary bg-pattern rounded-top">
                            ...
                            $sql = "SELECT COUNT(notif_id) FROM notifications WHERE messageTo='staff';";
                            $stmt = mysqli_query($conn, $sql);
                            $data = mysqli_fetch_assoc($stmt);
                            echo $data['COUNT(notif_id)'];
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                ...
                                $shownotif = mysqli_query($conn, "SELECT * FROM notifications WHERE messageTo ='staff' ORDER BY notif_id DESC");
                                ...
                                ?>
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative <?php if($data['saw_status'] == 0){echo "bg-soft-info";} ?>">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <a href="<?php if($data['transaction'] == "order"){echo "staff-tran-product.php";}elseif($data['status'] == "Completed"){echo "staff-tran-completed-p.php";} ?>" class="stretched-link">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">STAFF : <?php 
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-profile-staff.php"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                        ...
                        <a class="dropdown-item" href="staff-logout.php"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                    </div>
                </div>
            </div>
        </div>
