                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Rent Documents</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                                ...
                                                $stmt = mysqli_query($conn, "SELECT * FROM rent_transactions  WHERE (status IS NULL OR status!='canceled' OR status != 'declined') ORDER BY rent_id DESC");

                                                while($data = mysqli_fetch_assoc($stmt)){

                                                $accID = $data['cust_id'];
                                                $stmt1 = mysqli_query($conn, "SELECT fname, lname FROM clientacc WHERE cust_id ='$accID' ");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" onclick="showReq('<?php echo $data['rent_id']; ?>')" data-bs-toggle="modal" data-bs-target="#vanDetail" class="btn btn-info"><i class="fas fa-folder"></i></button>
...
<!-- END OF FOOTER -->
    ...
    <script>
        ...
        function showReq(rent_id){
            $("#showReq").load("db/ajaxShowRequirements2.php", {
                rent_id : rent_id
            });
        }
