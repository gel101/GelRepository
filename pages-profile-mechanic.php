  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="number" class="form-control" id="ephoneNum" required><span class="text-danger" id="phone_errr"></span>
            </div>
        </div>
        <br>
...
<!-- END OF FOOTER -->
    ...
    <script>
        ...
        function saveinfo(){
            var staff_id = '<?php echo $_SESSION['mechanic_id']; ?>';
            var accValid = '<?php echo $_SESSION['mechanic_username']; ?>';
                ...
                if (confirm("Confirm Changes?")) {
                    ...
                    success: function(response){
                        if(response['valid'] == false){
                            ...
                            // window.location.href="pages-profile-mechanic.php";
                        }        
                    }
                });
                }else{
