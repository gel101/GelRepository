                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Maintain / Repair Request</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Staff</a></li>
                                        <li class="breadcrumb-item active">Mechanic Request</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <?php
                                            ...
                                            $stmt = mysqli_query($conn, "SELECT * FROM request_services where status!='declined' AND status!='canceled' ORDER BY request_id DESC");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>
                                                    <form class="formLayout" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                        <input type="hidden" name="clientInfo" value="<?php echo $data['cust_id']; ?>">
                                                        <button type="submit" name="viewclientInfo" value="true" class="btn btn-primary"><i class="fas fa-user"></i></button>
                                                    <button type="button" class="btn btn-danger"><i class="fas fa-archive"></i></button>
                                                    </form>
