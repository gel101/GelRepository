                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <a href="mechanic-tran-approved.php">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Current Request</p>
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="                  
                                    <?php 
                                        include 'db/connection.php';

                                        $mechanic_id = $_SESSION['mechanic_id'];
                                        $sql = "SELECT COUNT(request_id) FROM request_services WHERE status='approved' AND mechanic_id='$mechanic_id' ";
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <a href="mechanic-tran-completed.php">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Completed Request</p>
                                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="
                                    <?php 
                                        include 'db/connection.php';

                                        $mechanic_id = $_SESSION['mechanic_id'];
                                        $sql = "SELECT COUNT(request_id) FROM request_services WHERE status='request completed' AND mechanic_id='$mechanic_id' ";
                                        $stmt = mysqli_query($conn, $sql);
                                        $data = mysqli_fetch_assoc($stmt);
                                        echo $data['COUNT(request_id)'];
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header border-0 align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Services Revenue</h4>
                                </div>
