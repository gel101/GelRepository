                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Completed Request</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(o);">Mechanic</a></li>
                                        <li class="breadcrumb-item active">Completed Service</li>
                                    </ol>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if (isset($_SESSION['mechanic_id'])) {
                                                    ...
                                                    $stmt = mysqli_query($conn, "SELECT * FROM request_services where mechanic_id='$mechanic_id' AND status = 'request completed' ORDER BY request_id DESC");
                                            ...
                                            <tr>
                                                ...
                                                switch ($data['status']) {
                                                    ...
                                                    case "Request Completed":
                                                        echo "<span class='badge bg-success'>Request Completed</span>";
                                                        break;
                                                    default:
                                                        echo "<span class='badge bg-danger'>Something's Error</span>";
                                                }
