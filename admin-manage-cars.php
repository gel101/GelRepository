                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Manage Stock</h4>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-6">
						<label class="form-label">Chasis Number</label><span class="a_chassis_err text-danger"></span>
						<input class="form-control" id="carChassis" name="carChassis" type="text" placeholder="Enter Chassis Number" required>
						<br>
					</div>
					<div class="col-md-6">
						<label class="form-label">Temporary Plate Number</label><span class="a_tempPlate_err text-danger"></span>
						<input class="form-control" id="cartempPlate" name="cartempPlate" type="text" placeholder="Enter Tempoarary Plate Number" required>
						<br>
					</div>
				</div>
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<input class="form-control" id="ecarChassis" name="ecarChassis" type="text" placeholder="Enter Chassis Number" required>
						<br>
					</div>
					<div class="col-md-6">
						<label class="form-label">Temporary Plate Number</label><span class="e_tempPlate_err text-danger"></span>
						<input class="form-control" id="ecartempPlate" name="ecartempPlate" type="text" placeholder="Enter Tempoarary Plate Number" required>
						<br>
					</div>
				</div>
