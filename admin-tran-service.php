            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <?php
                                $stmtService = mysqli_query($conn, "SELECT * FROM services ORDER BY id ASC");
                                while($dataservice = mysqli_fetch_assoc($stmtService)){
                            ?>

                            <div class="col-md-4 service-request"> <!-- Adjust the column size based on your needs -->
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="requestType[]" value="<?php echo $dataservice['service']; ?>">
                                    <label class="form-check-label"><?php echo $dataservice['service']; ?></label>
                                </div>
                            </div>
			...
			<div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="priceReason" class="form-label">Things that Used to the Service / Reasons to the Price</label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 assignMecBtn" style="position:absolute;bottom:20px;right:1px;">
