                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label for="priceReason" class="form-label">Things that Used to the Service / Reason to the Price</label>
...
<div class="modal fade" id="tranDetail">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                    <label for="minfo" class="form-label">Things that Used to the Service / Basis for the Price</label>
