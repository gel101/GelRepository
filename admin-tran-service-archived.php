...
<!-- Main content -->
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                        <h4 class="title">Declined Service</h4>
                                        <br>
                                        <br>
                        ...
                        <?php
                            ...
                            $stmt = mysqli_query($conn, "SELECT * FROM request_services WHERE status='declined' ORDER BY request_id DESC");
                        ...
                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary" onclick="recoverBtn('<?php echo $data['request_id']; ?>')" type="button"><i class="fas fa-trash-restore"></i></button>
                                                </td>
                                            </tr>
                        <?php
                            }
...
<!-- END OF FOOTER -->
    ...
    <script>
        ...
        function recoverBtn(request_id){
