                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Gcash</li>
                                    </ol>
                                </div>
...
<div class="row">
    <div class="col-md-6">
        <h2 style="color:#007DFE" class="textSearch"><strong>Gcash</strong></h2>
    </div>
    <div class="col-md-6" style="text-align:center">
    </div>
</div>
<div class="row">
    <div class="col-md-6 h-auto w-50">
            <?php if ($data['screenshot'] != "") { ?>
        <a href="db/<?php echo $data['screenshot']; ?>"  target="_blank" class="form-control">
