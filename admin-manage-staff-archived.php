                                ...
                                <div class="card-body">
									...
									<table class="table text-center">
										...
										<tbody>
												...
												$stmt = mysqli_query($conn, "SELECT * FROM staff WHERE status='archived' ORDER BY staff_id DESC");
												...
												<tr>
													...
													<td>
														<button class="btn btn-primary" onclick="recoverBtn('<?php echo $data['staff_id']; ?>')">RECOVER</button>
													</td>
												</tr>
												<?php
													}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                    ...
                    <input class="form-control" id="pass" type="password" placeholder="Enter Age">
                    <br>
...
// FOR SPARE PARTS 
	...
	function editmechanic(fname, lname, age, pNum, user, pass, staff_id){
		var fname = fname;
		var lname = lname;
		var age = age;
		var pNum = pNum;
	...
	function deletemechanic(staff_id){
