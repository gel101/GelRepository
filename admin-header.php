<head>
    <style>
        ...
        /* Adjust the modal's z-index to appear in front of the backdrop */
        .modal {
            z-index: 1050; /* You can adjust this value as needed */
        }

        /* Adjust the backdrop's z-index to appear behind the modal */
        .modal-backdrop {
            z-index: 1040; /* You can adjust this value as needed */
            opacity: 0.6; /* Optional: Reduce backdrop opacity if desired */
        }
...
if (isset($_SESSION['admin_last_activity']) && (time() > ($_SESSION['admin_last_activity'] + 43200))) {
    echo "<script>
...
if ($_SESSION["adminLogin"] === false || !isset($_SESSION["admin_id"])) {
    echo "<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('hiddenButton').click();
    });
            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="admin-dashboard.php" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="img/logo-dark.png" alt="" height="40">
                        </span>
                        <span class="logo-lg">
                            <img src="img/logo-dark.png" alt="" height="80">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" onclick="sawStatusBtn()" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        $sql123 = "SELECT * FROM notifications WHERE messageTo = 'admin' and saw_status= 0; ";
                        ...
                        ?>">
                            <?php 
                            $sql = "SELECT COUNT(notif_id) FROM notifications WHERE messageTo='admin'AND saw_status = 0;";
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <div class="dropdown-head bg-primary bg-pattern rounded-top">
                            ...
                            $sql = "SELECT COUNT(notif_id) FROM notifications WHERE messageTo='admin';";
                            $stmt = mysqli_query($conn, $sql);
                            $data = mysqli_fetch_assoc($stmt);
                            echo $data['COUNT(notif_id)'];
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                ...
                                $shownotif = mysqli_query($conn, "SELECT * FROM notifications WHERE messageTo ='admin' ORDER BY notif_id DESC");
                                ...
                                ?>
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative <?php if($data['saw_status'] == 0){echo "bg-soft-info";} ?>">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <a href="<?php if($data['transaction'] == "order"){echo "admin-tran-product.php";}if($data['transaction'] == "service"){echo "admin-tran-service.php";} ?>" class="stretched-link">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">   
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">ADMIN : <?php 
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome Master!</h6>
                        <a class="dropdown-item" href="pages-profile-admin.php"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                        ...
                        <a class="dropdown-item" id="lockscreenTrigger" href="#"><i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Lock screen</span></a>
                        <form action="admin-logout.php" method="post" class="d-none">
                            <button type="submit" id="lockscreenTriggerBtn" name="toLockscreen" value="1"></button>
                        </form>
                        <a class="dropdown-item" href="admin-logout.php"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#lockscreenTrigger').click(function() {
            $('#lockscreenTriggerBtn').click();
        });
    });
    ...
    // Use to show decision Modal in the Accept Transaction in the admin transaction
    // function acceptBtn(cust_id, tran_id) {
    //     var valid = true;
    //     // To remove the "No" button
    //     $('#decisionModal .center button[data-bs-target="#vanDetail"]').remove();
        
    //     if (valid) {
    //         $('.messageText').text('Confirm Order Acceptance?'); // Change the confirmation text

    //         $('.dismissBtn').click();
    //         $('#decisionModal').modal('show');

    //         // Add data-bs-target to the "No" button
    //         var noButton = $('<button/>', {
    //             class: 'btn btn-danger',
    //             'data-bs-dismiss': 'modal',
    //             'data-bs-toggle': 'modal',
    //             'data-bs-target': '#vanDetail', // Add this line
    //             text: 'No'
    //         });
    ...
    //                         $('#scModal').modal('show');
    //                         alert(response['msg']);
    //                         window.location.href = "admin-tran-product.php";
    //                     }
    ...
    //             $('#decisionModal').modal('hide'); // Close the modal after confirmation
    //         });

    //         // Append the modified "No" button to the modal
    //         $('#decisionModal .center').append(noButton);
    //     }
    // }
</script>