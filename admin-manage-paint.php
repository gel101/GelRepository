							...
							<div class="card">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-2">
											<span class="buttonSpan"><button type="button" onclick="addPaint()" class="btn btn-primary">Add New Paint</button></span>
										</div>
									</div>
									<br>
...
<div class="modal fade" id="addModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<label class="form-label">Paint Image</label><span class="a_img_err text-danger"></span>
				<input class="form-control" type="file" name="paintImg" id="paintImg"required>
				<br>
				<div class="row">
					<div class="col-md-6">
						<label class="form-label">Color</label><span class="a_name_err text-danger"></span>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<label class="form-label">Image Color</label><span class="e_img_err text-danger"></span>
				<input class="form-control" type="file" name="epaintImg" id="epaintImg" required>
				<br>
				<div class="row">
					<div class="col md-6">
						<label class="form-label">Color</label><span class="e_name_err text-danger"></span>
