                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    $stmt = mysqli_query($conn, "SELECT * FROM admin WHERE admin_id='$adminID'");
                                    ...
                                    ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" id="pass" value="<?php echo $data['password']; ?>"></input>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <td>
...
<!-- END OF FOOTER -->
    ...
    <script>
        ...
        function saveinfo(){
            var cust_id = '<?php echo $_SESSION['admin_id']; ?>';
