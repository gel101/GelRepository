                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-warning" onclick="showOrder('<?php echo $data['payment_term'] . '(' . $data['payment_mode'] . ' ' . $data['reference_number'] . ')'; ?>','<?php echo $data['cust_id']; ?>', '<?php echo $data['tran_id']; ?>', '<?php echo $data['status']; ?>')" data-bs-toggle="modal" data-bs-target="#vanDetail"><i class="fas fa-eye"></i></button>
...
<div class="modal fade" id="vanDetail">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h3 id="title">All Client Order</h3><span id="paymentStatus"><span class="badge bg-success" style="margin-left:10px" id="paymentTerm"></span></span>
