        ...
        <div class="col-md-4 float-end">
            ...
            <div class="card-container col-12">
                        ...
                        <?php
                            ...
                            $stmt = mysqli_query($conn, "SELECT * FROM spareparts_accessories WHERE quantity > 0 AND status != 'archived' ORDER BY sparepart_id DESC");
                ...
                <div class="box card">
                    ...
                    <div class="row-12">
                        ...
                        <div class="col-md-2">
                            <div class="showdetailsign" data-value-1="<?php echo $data['details']; ?>" onclick="showdetails(this.getAttribute('data-value-1'))">
                                <h4><i class="fas fa-info-circle fa-lg"></i></h4>
                            </div>
                        </div>
                    </div>
