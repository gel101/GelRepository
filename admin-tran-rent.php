									...
									<tbody>
										...
										<tr>
											...
											<td class="text-end text-center">
                                                ...
                                                <button type="button" class="btn btn-secondary <?php if ($data['status'] != "Accepted") {echo 'd-none';} ?>" onclick="preApprove('<?php echo $data['rent_id']; ?>')" data-bs-toggle="modal" data-bs-target="#fileUploadModal"><i class="fas fa-check-double"></i></button>
                                                <button type="button" class="btn btn-success <?php if ($data['status'] != "In Use") {echo 'd-none';} ?>" onclick="returnRent('<?php echo $data['rent_id']; ?>')"><i class="fas fa-car"></i> <i class="fas fa-check"></i></button>
			...
			<div class="modal-body">
                <div id="con1">
                    <form id="uploadForm" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="" class="form-label">Driver's License</label><span class="text-danger"> *Required</span>
                                ...
                                <br>
                                <label for="" class="form-label">Prove of Billing Address(Electric Bill)/Resident Address</label><span class="text-danger"> *Required</span>
                                <input class="form-control" type="file" name="addProff" id="addProff" required>
                                <br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <br>
                                <label for="" class="form-label">Amount of Payment</label><span class="text-danger"> *Required</span>
...
<!-- END OF FOOTER -->
    ...
    <script>
        ...
        function returnRent(rent_id){
            if (confirm("Did the rent end, and the car was returned?")) {
                var form_data = {
                    rent_id : rent_id
                }
